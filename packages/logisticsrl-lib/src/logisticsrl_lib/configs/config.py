...
class Config:
    ...
    run_name: str = "pointer_policy_a2c_knn"
    seed: int = 42
    ...
    entropy_bonus: float = 0.07  # Coefficient for entropy bonus to encourage exploration
    value_coef: float = 0.1      # Coefficient for critic (value) loss in A2C
