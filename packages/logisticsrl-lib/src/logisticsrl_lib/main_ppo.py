...
def train():
    ...
    for episode in range(1, total_timesteps // n_steps + 1):
        model.learn(total_timesteps=n_steps, reset_num_timesteps=False)

        # Report every 20 episodes
        if episode % 20 == 0:
            ...
            report_every_20_episodes(
                episode,
                0,  # Replace with actual reward if needed
                0,  # Replace with actual loss if needed
                total_time,
